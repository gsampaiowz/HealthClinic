...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdClinica).HasName("PK__Clinica__52A90951BF2D8476");

            entity.ToTable("Clinica");

            entity.HasIndex(e => e.Endereco, "UQ__Clinica__4DF3E1FF31490AF7").IsUnique();

            entity.HasIndex(e => e.Unidade, "UQ__Clinica__A2FB7B67C9419EFF").IsUnique();

            entity.HasIndex(e => e.Cnpj, "UQ__Clinica__AA57D6B4AC7E92BD").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdComentario).HasName("PK__Comentar__DDBEFBF9312482B0");
            ...
            entity.HasOne(d => d.IdPacienteNavigation).WithMany(p => p.Comentarios)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Comentari__IdPac__70DDC3D8");
        });

        modelBuilder.Entity<Consulta>(entity =>
        {
            entity.HasKey(e => e.IdConsulta).HasName("PK__Consulta__9B2AD1D86F33A7CF");
        ...
        {
            entity.HasKey(e => e.IdEspecialidade).HasName("PK__Especial__5676CEFF3041632C");

            entity.ToTable("Especialidade");

            entity.HasIndex(e => e.NomeEspecialidade, "UQ__Especial__D6E5EBAE777E3ABF").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdMedico).HasName("PK__Medico__C326E652C039C787");

            entity.ToTable("Medico");

            entity.HasIndex(e => e.IdUsuario, "UQ__Medico__5B65BF96C14BA4CD").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdPaciente).HasName("PK__Paciente__C93DB49BDDAD634E");

            entity.ToTable("Paciente");

            entity.HasIndex(e => e.Rg, "UQ__Paciente__321537C860A58A83").IsUnique();

            entity.HasIndex(e => e.Telefone, "UQ__Paciente__4EC504B6FF98E5E3").IsUnique();

            entity.HasIndex(e => e.IdUsuario, "UQ__Paciente__5B65BF962F2CD3FE").IsUnique();

            entity.HasIndex(e => e.Cpf, "UQ__Paciente__C1F89731CB51090D").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdProntuario).HasName("PK__Prontuar__3AB81E66B6033753");

            entity.ToTable("Prontuario");

            entity.HasIndex(e => e.IdConsulta, "UQ__Prontuar__9B2AD1D95219E242").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdSituacao).HasName("PK__Situacao__810BCE3A168BBE7D");

            entity.ToTable("Situacao");

            entity.HasIndex(e => e.TituloSituacao, "UQ__Situacao__E031B903E4737C89").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDeUsuario).HasName("PK__TipoDeUs__8C8B582A783D2034");

            entity.ToTable("TipoDeUsuario");

            entity.HasIndex(e => e.NomeTipoDeUsuario, "UQ__TipoDeUs__D2C28208DCDDBBA5").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9790147DC6");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053405570DBD").IsUnique();
